...
def get_product(barcode, locale='fr'):
    """
...
def get_by_facets(query, page=1, locale='fr'):
    """
...
def add_new_product(post_data, locale='fr'):
    """
    ...
    url = utils.build_url(geography='fr',
                          service='cgi',
...
def search(query, page=1, page_size=20,
           sort_by='unique_scans', locale='fr'):
    """
